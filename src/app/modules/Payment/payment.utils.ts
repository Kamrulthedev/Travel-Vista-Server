...
export const initialePayment = async (OrderDate: any) => {
  const response = await axios.post(process.env.PAYMENT_URL!, {
    ...
    success_url: `https://travel-vista-server.vercel.app/api/confirmation?
transactionId=${OrderDate.transactionId}&id=${OrderDate.BookinId}&status=success`,
    fail_url: `https://travel-vista-server.vercel.app/api/confirmation?&status=Faild`,
    cancel_url: 'https://travelvista.vercel.app/',
